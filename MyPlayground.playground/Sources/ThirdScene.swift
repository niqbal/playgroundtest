...
class ThirdScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if (firstBody.node?.name)! == "Player" && (secondBody.node?.name == "Alpha 1" || secondBody.node?.name == "Alpha 2" || secondBody.node?.name == "Alpha 14" ||  secondBody.node?.name == "Bomb" ) {
            ...
            if(secondBody.node?.name=="Alpha 2" && n2==0){
                
                childNode(withName:"b")?.alpha=1;
                score += 1;
                count = count+1;
                scoreLabel?.text = String(score);
                secondBody.node?.removeFromParent();
            ...
            if(secondBody.node?.name=="Alpha 14" && n3==0){
            ...
            if(secondBody.node?.name=="Alpha 1" && n4==0){
                
                childNode(withName:"a1")?.alpha=1;
                score += 1;
                count = count+1;
                scoreLabel?.text = String(score);
                secondBody.node?.removeFromParent();
            ...
            if(secondBody.node?.name=="Alpha 14" && n5==0){
                
                childNode(withName:"n1")?.alpha=1;
                score += 1;
                count = count+1;
                scoreLabel?.text = String(score);
                secondBody.node?.removeFromParent();
            ...
            if(secondBody.node?.name=="Alpha 1" && n6==0){
                
                childNode(withName:"a2")?.alpha=1;
                score += 1;
                count = count+1;
                scoreLabel?.text = String(score);
                secondBody.node?.removeFromParent();
